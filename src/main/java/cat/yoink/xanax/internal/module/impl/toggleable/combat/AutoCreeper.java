 ...
 * @author yoink
 */
@ModuleData(name = "AutoCreeper", aliases = {"AutoCreeper", "Creeper", "AutoSpawn", "Spawner"}, category = ModuleCategory.COMBAT, description = "Automatically spawns creepers inside someone")
