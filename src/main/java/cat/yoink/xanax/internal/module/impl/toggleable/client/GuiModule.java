 ...
 * @author yoink
 */
@ModuleData(name = "ClickGUI", aliases = {"ClickGUI", "GUI", "Menu"}, category = ModuleCategory.CLIENT, defaultBind = Keyboard.KEY_RSHIFT, description = "Toggle modules and settings in a gui", noSave = true)
